...
ColorGradingUI::ColorGradingUI( ColorGradingPtr colgrad, QWidget *parent) : QWidget(parent), m_colgrad(colgrad)//, m_nebulae(nebulae)
{
	ui.setupUi(this);
...
{
	m_colgrad->shader->reload();
	m_colgrad->lightMapShader->reload();
	emit makeDirty();
}
