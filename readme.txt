...
info
-cloud are 1million points (http://www.infinity-universe.com/Infinity/index.php?option=com_smf&Itemid=75&topic=1769.0)
-lots of fine tuning
-smoke like particle texture

strange attractors (http://www.infinity-universe.com/Infinity/index.php?option=com_smf&Itemid=75&topic=1670.0)
-uses pickover equation
...
glow effect (http://www.infinity-universe.com/Infinity/index.php?option=com_smf&Itemid=75&topic=1728.0)
...
homogenise particles (http://www.infinity-universe.com/Infinity/index.php?option=com_smf&Itemid=75&topic=1728.0)
...
-add stars and render them as billboards (using additive blending)
-add bok globules and render them as billboards (using negative blending)
-use seperate texture for particle colors; compute color from distance to stars and their color
